...
v16 account system: local browser-only registration/login with username, hashed password, and optional profile picture. Static GitHub Pages cannot provide shared server accounts; for real multi-device accounts, connect an auth/backend service.
